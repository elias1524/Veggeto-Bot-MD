...
let Veggeto = `🚩 *Respeta las reglas de Yaemori*\n
✰ No llamar Al Bot
✰ No hacer spam
...
⚠️ 𝗔𝘃𝗶𝘀𝗼: *Puedes apoyarnos dejando una estrellita 🌟 al repositorio oficial de Veggeto.*

${global.md}`.trim()
await conn.reply(m.chat, Veggeto, m, fake)
